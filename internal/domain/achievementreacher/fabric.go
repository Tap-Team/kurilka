...
func NewPercentableFabric(cigaretteAmount, moneySaved int, abstinenceTime time.Time) PercentableFabric {
	return &percentFabric{cigarette: cigaretteAmount, money: moneySaved, abstinenceTime: abstinenceTime}
}
